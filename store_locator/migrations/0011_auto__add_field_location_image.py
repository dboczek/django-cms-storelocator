...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'store_locator_location', 'image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'store_locator_location', 'image_id')
    ...
    models = {
        ...
        u'store_locator.location': {
            ...
            'location_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['store_locator.LocationType']", 'null': 'True', 'blank': 'True'}),
            'longitude': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'store_locator.locationtype': {
            'Meta': {'object_name': 'LocationType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'store_locator.storelocator': {
            'Meta': {'object_name': 'StoreLocator', 'db_table': "u'cmsplugin_storelocator'", '_ormbases': ['cms.CMSPlugin']},
            ...
            'show_location_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['store_locator.LocationType']", 'null': 'True', 'blank': 'True'}),
